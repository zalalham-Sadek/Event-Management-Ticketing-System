    ...
    <div class="w-full lg:w-1/3 flex items-center justify-center p-8 bg-[#f7f9fd] dark:bg-[#1f2937]">
      <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
          <h2 class="text-3xl font-bold text-gradient mb-2">{{$t('Welcome Back')}}</h2>
          <p class="text-gray-600 dark:text-gray-300">{{$t('Sign in to your account to continue')}}</p>
        </div>
...
/>
          ...
          >
            <span v-if="!isLoading">{{$t('Sign in')}}</span>
        ...
        <div class="mt-6 text-center">
          <p class="text-gray-600 dark:text-gray-300">
            ...
            <router-link to="/register" class="text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300 font-medium transition-colors duration-200">
              {{$t('Create an account')}}
            </router-link>
          </p>
        </div>
