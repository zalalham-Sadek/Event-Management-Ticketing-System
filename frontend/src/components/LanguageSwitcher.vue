...
const otherLanguage = computed(() =>
  selectedLanguage.value === "en" ? "ar" : "en"
);

const toggleLanguage = () => {
  selectedLanguage.value = otherLanguage.value;
